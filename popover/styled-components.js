...
function getBodyStyles(props) {
  ...
  return _objectSpread({
    ...
    transform: $isAnimating && $isOpen ? (0, _utils.getEndPosition)($popoverOffset) : (0, _utils.getStartPosition)($popoverOffset, $placement, $showArrow, $popoverMargin)
  }, (0, _utils.getPopoverMarginStyles)($showArrow, $placement, $popoverMargin));
}
