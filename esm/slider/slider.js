...
export function useHover() {
  var _React$useState = React.useState(false),
      ...
      setValue = _React$useState2[1]; // eslint-disable-next-line flowtype/no-weak-types
...
function Slider(_ref) {
  ...
  var _useHover = useHover(),
      ...
      hoverRef0 = _useHover2[0],
      isHovered0 = _useHover2[1];

  var _useHover3 = useHover(),
      _useHover4 = _slicedToArray(_useHover3, 2),
      hoverRef1 = _useHover4[0],
      isHovered1 = _useHover4[1];

  var _React$useState3 = React.useState(false),
      _React$useState4 = _slicedToArray(_React$useState3, 2),
      isFocusVisible = _React$useState4[0],
      setIsFocusVisible = _React$useState4[1];

  var _React$useState5 = React.useState(-1),
      _React$useState6 = _slicedToArray(_React$useState5, 2),
      focusedThumbIndex = _React$useState6[0],
      setFocusedThumbIndex = _React$useState6[1];
