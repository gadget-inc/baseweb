...
export function getPopoverMarginStyles(showArrow, placement, popoverMargin) {
  ...
  return _defineProperty({}, property, "".concat(showArrow ? ARROW_SIZE : popoverMargin, "px"));
}
/**
 * Returns CSS rules for the popover animation start keyframe
 */

export function getStartPosition(offset, placement, showArrow, popoverMargin) {
  ...
  var margin = (showArrow ? ARROW_SIZE : popoverMargin) * 2;
