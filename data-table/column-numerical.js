...
var NumericalCell = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  return /*#__PURE__*/React.createElement(_cellShell.default, {
    ref: ref,
...
function NumericalColumn(options) {
  ...
  return {
    ...
    renderCell: /*#__PURE__*/React.forwardRef(function (props, ref) {
      return /*#__PURE__*/React.createElement(NumericalCell, {
        ref: ref,
        isMeasured: props.isMeasured,
        isSelected: props.isSelected,
        onSelect: props.onSelect,
