...
var wrapper = function wrapper(StyledComponent) {
  return /*#__PURE__*/React.forwardRef(function (props, ref) {
    return /*#__PURE__*/React.createElement(_themeProvider.ThemeContext.Consumer, null, function (themeAndOverrides) {
...
function createThemedUseStyletron() {
  return function () {
    // eslint-disable-next-line flowtype/no-weak-types
    var theme = React.useContext(_themeProvider.ThemeContext).theme;
...
StyledElement, wrapperFn) {
  ...
  return (0, _styletronReact.withWrapper)(StyledElement, function (Styled) {
    return /*#__PURE__*/React.forwardRef(function (props, ref) {
      return /*#__PURE__*/React.createElement(_themeProvider.ThemeContext.Consumer, null, function (_ref) {
